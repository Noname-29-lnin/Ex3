...
void Vtb_Question6___024root___timing_resume(Vtb_Question6___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_hcd689571__0.resume("@(posedge tb_Question6.i_clk)");
    }
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_hcd689520__0.resume("@(negedge tb_Question6.i_clk)");
    }
...
void Vtb_Question6___024root___timing_commit(Vtb_Question6___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_Question6__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_Question6___024root___timing_commit\n"); );
    // Body
    if ((! (2ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_hcd689571__0.commit("@(posedge tb_Question6.i_clk)");
    }
    if ((! (4ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_hcd689520__0.commit("@(negedge tb_Question6.i_clk)");
    }
}
...
bool Vtb_Question6___024root___eval_phase__act(Vtb_Question6___024root* vlSelf) {
    ...
    Vtb_Question6___024root___timing_commit(vlSelf);
...
#endif
            VL_FATAL_MT("/home/noname/Documents/project_tiny/Ex3/03_verif/DUT/Question6/tb_Question6.sv", 2, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/home/noname/Documents/project_tiny/Ex3/03_verif/DUT/Question6/tb_Question6.sv", 2, "", "Active region did not converge.");
            }
