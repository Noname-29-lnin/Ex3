...
void Vtb_lib___024root___eval_triggers__ico(Vtb_lib___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_lib___024root___eval_triggers__ico\n"); );
    // Body
...
void Vtb_lib___024root___eval_triggers__act(Vtb_lib___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_lib__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_lib___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, (((IData)(vlSelf->tb_top__DOT__i_clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_top__DOT__i_clk__0))) 
                                     | ((~ (IData)(vlSelf->tb_top__DOT__i_rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_top__DOT__i_rst_n__0))));
    vlSelf->__VactTriggered.set(1U, ((((IData)(vlSelf->tb_top__DOT__i_clk) 
                                       ^ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_top__DOT__i_clk__0)) 
                                      | ((~ (IData)(vlSelf->tb_top__DOT__i_rst_n)) 
                                         & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_top__DOT__i_rst_n__0))) 
                                     | vlSelf->__VdlySched.awaitingCurrentTime()));
    vlSelf->__VactTriggered.set(2U, vlSelf->__VdlySched.awaitingCurrentTime());
    vlSelf->__VactTriggered.set(3U, ((~ (IData)(vlSelf->tb_top__DOT__i_clk)) 
                                     & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_top__DOT__i_clk__0)));
