...
\lstinputlisting[style=StyleCode, language=SystemVerilog, caption={Chương trình mô tả LOPD 4-bit.}]{./../02_rtl/Question2/LOPD_4bit.sv}

\lstinputlisting[style=StyleCode, language=SystemVerilog, caption={Chương trình mô tả LOPD 8-bit.}]{./../02_rtl/Question2/LOPD_8bit.sv}

\lstinputlisting[style=StyleCode, language=SystemVerilog, caption={Chương trình mô tả LOPD 16-bit.}]{./../02_rtl/Question2/LOPD_16bit.sv}

\lstinputlisting[style=StyleCode, language=SystemVerilog, caption={Chương trình mô tả LOPD 24-bit.}]{./../02_rtl/Question2/Question2.sv}

Thực hiện sử dụng Yosys để kiểm tra số lượng cell sử dụng cho câu 2:
\begin{lstlisting}[style=StyleResult, language=Result, caption={Số lượng Cell sử dụng cho câu 2.}]
	=== design hierarchy ===
