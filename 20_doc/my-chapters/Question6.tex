...
Thực hiện sử dụng Yosys để kiểm tra số lượng cell sử dụng cho câu 6:
\begin{lstlisting}[style=StyleResult, language=Result, caption={Số lượng Cell sử dụng cho câu 6.}]
	=== design hierarchy ===
	
		+----------Count including submodules.
		| 
		1240 Bitonic_Sort
		2   $paramod$f7088a211ff736e5257e09ddc21bfc9d7d309b67\Compare_and_Swap_unit
